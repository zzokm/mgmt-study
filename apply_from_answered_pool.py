...
Workflow for new chapter updates:
  1. Edit or create answered-pools/<slug>.json (dual refs: chN:s* slides, chN,p* textbook).
  2. Set printedPageStart in book_manifest.json for that chapter if using footer page numbers.
...
POOLS_DIR = ROOT / "question-pools-by-lecture"
EXAM_FILES = {
    "final19.json": ROOT / "final19.json",
    "final21.json": ROOT / "final21.json",
    "final24.json": ROOT / "final24.json",
    "final25.json": ROOT / "final25.json",
}
REPETITIVE = ROOT / "repetitive-questions.json"
