    ...
    <div className="mx-auto flex max-w-4xl flex-col gap-8">
      ...
      <Card className="border-primary/25 bg-muted/40">
        <CardHeader className="pb-2">
          ...
          <CardDescription>
            Thank you for using this site. Your feedback helps improve resources for similar future projects.
          </CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <p className="text-sm text-muted-foreground">
            If you have a minute, please share how the platform worked for you — ratings,
            what helped most, and any suggestions.
          </p>
          <a
